...
elif top_file.endswith(".vts"):
  top = vtk.vtkXMLStructuredGridReader()
else:
  print "This program has not yet been configured to read", top_file
  p.print_help()
  sys.exit(2)
...
if vtp_out.endswith(".vtp"):
  writer = vtk.vtkXMLPolyDataWriter()
elif vtp_out.endswith(".vts"):
  writer = vtk.vtkXMLStructuredGridWriter()
else:
  print "This program has not yet been configured to write", vtp_out
  p.print_help()
  sys.exit(2)
